...
A 获取了A锁
B 获取了B锁
Thread[Thread-1,5,main]接着获取A
Thread[Thread-0,5,main]接着获取B
// 阻塞， 死锁现象发生
```

**如何定位**

可以使用jps和jstack快速定位以下：

```plain
D:\Java_Project\Java_Learn_samples>jps

6332 DeadLockTest2

D:\Java_Project\Java_Learn_samples>jstack 6332

```

![image-20210326230901591](img/并发基础常见面试题/image-20210326230901591.png)
